...
if __name__ == '__main__':
    ...
    parser.add_argument('--prjt_id', type=str, default='test_mcnn')     # Default value for testing
    ...
    parser.add_argument('--prior_dir', type=str,    # Default value for testing
                        default='/home/istream3/matrix/apps/tomcat-8.5.39/webapps/bizmdl/metax/prj_data/M04/P41')
    parser.add_argument('--curr_dir', type=str,     # Default value for testing
                        default='/home/istream3/matrix/apps/tomcat-8.5.39/webapps/bizmdl/metax/prj_data/M04/P42/test')
    ...
    config.read(test_path, encoding='utf-8')
    ...
    if args.network_cls in ["modified_mcnn"]:
        ...
        log_path = os.path.join(args.curr_dir, 'model', 'hetero', 'model_log', 'train_csv', 'log.csv')
